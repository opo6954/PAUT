...
namespace vrat
{
    ...
    public class PropertyVisualizeHandler : MonoBehaviour
    {
        ...
        public void visualizePropertyRaw(string paramName, VISUALIZEPROPTYPE vp, string paramValue, string[] _additionalInfo, int idx, int _xOffset=20, int _yOffset=-30)
        {
        ...
        public void visualizePropertyAll(XmlTemplate xt, int i, int _xOffset, int _yOffset)
        {
            xOffset = _xOffset;
            yOffset = _yOffset;
        ...
        void visualizeProperty(VariableXmlTemplate vxt, int idx)
        {
            ...
            sit.setValue(vxt.getValue());
            sit.setCallback(vxt.setValue);
