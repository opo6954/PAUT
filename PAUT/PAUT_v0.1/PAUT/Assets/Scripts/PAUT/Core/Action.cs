...
namespace PAUT
{
    ...
    public class Action : ICloneable
    {
        ...
        public Action(ActionType _type, Asset _asset, Vector3 _paramVec, float _paramFloat, bool _paramBool, string _paramString)
        {
            type = _type; asset = _asset; paramBool = _paramBool; paramVec = _paramVec; paramFloat = _paramFloat; paramString = _paramString;
        }
        ...
        public object Clone()
        {
			return new Action(this.type, this.asset, this.paramVec, this.paramFloat, this.paramBool, this.paramString);
        }
