...
namespace vrat
{
    ...
    public class AuthorableEvent : ObjectTemplate
    {
        ...
        public void addInstruction(PAUTPrimitivesTemplate origin)
        {
            ...
            instruction.clearParamValueAll();
		...
		{
			ListOfXmlTemplate loxt = variableContainer.getParameters ("InstructionList") as ListOfXmlTemplate;

			InstPrimitivesTemplate instruction = loxt.getXmlTemplate (0) as InstPrimitivesTemplate;
			string value = "";
			;
			return instruction.getParameterValue ("Instruction", ref value);
